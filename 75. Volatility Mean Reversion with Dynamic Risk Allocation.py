...
"""
Define the limits of how small a trade size can be and what the
...
increment slowly if we continue to do well.
"""
...
"""
Define similar minimum, maximum, and increment values for the
...
for close_price in close:
    ...
    """
    Main trading section. It will require some changes so that
    it adapts to the changing trade sizes.
    """
    ...
    """
    After adjusting the PnLs, as shown in the preceding code, we will add an
    ...
    if len(pnls) > 20:
        ...
        if len(pnls) - last_risk_change_index > 20:
            if monthly_pnls > 0:
                ...
                """
                Similar logic, but which reduces risk after a month of poor performance:
                """
                num_shares_per_trade -= INCREMENT_NUM_SHARES_PER_TRADE
